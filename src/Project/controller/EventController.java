...
public class EventController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (action.equalsIgnoreCase("Reserve"))  {
			...
			Event e = (Event) session.getAttribute("Selected_Event");
			...
			if (!CerrorMsgs.getM_errorMsg().equals("")) {
				...
				session.setAttribute("errorMsgsForReg", CerrorMsgs);
				url = "/reserve.jsp";
			} else {
...
//			}
			...
			//("Retrived session current username"+currentuser);
			//("Retrived session event time"+eventTime);
			//("Retrived session session event type"+eventType);
//			SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
//			
			DateFormat parser = new SimpleDateFormat("MM/dd/yyyy");
			try {
...
//			
			...
			if (CerrorMsgs.getM_errorMsg().equals("")) {
				...
				//	session.setAttribute("EVENTS", );
					...
					//("User obj retured"+currentUserReturned);
					session.setAttribute("current_user", currentUserReturned);
					//("printing from Event controller while going to evemt sum page"+currentUserReturned.getUsername());
		...
		else if(action.equalsIgnoreCase("listSpecificEventForManager")) { // action=listSpecificCompany
			ArrayList<Event> companyInDB = new ArrayList<Event>();
			Event selectedEvent= new Event();
...
//			//("Inside Reserve Event block of Evenet Controller");
//			getEventParam(request, event);
...
//				//("Printing capacity inside Reserve Clause"+e.getM_capacity());
//				//("Printing capacity inside Reserve Clause"+e.getM_numberofattendees());
//				//("Printing capacity inside Reserve Clause"+e.getM_event_date());
//				//("Printing capacity inside Reserve Clause"+e.getM_event_name());
//				//("Printing capacity inside Reserve Clause"+e.getM_start_time());
//				//("Printing capacity inside Reserve Clause"+e.getM_type());
//				//("Printing capacity inside Reserve Clause"+e.getM_start_time());
//			
//				EventDAO.insertEvent(e);
//				
//			//("Event Succesfully Registered");
//			
//				url="";
//			}
//		}
